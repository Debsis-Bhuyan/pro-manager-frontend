...
const Card = ({
  ...
  const {
    ...
    dueDate,
  } = task; // Renamed checklist to taskChecklist
  ...
  const handleStatusChange = async (newStatus) => {
    try {
      ...
      const response = await axios.put(
        `${BACKEND_URL}/tasks/${taskId}/status`,
        {
          status: newStatus,
        },
        {
        ...
        <div className={styles.optionsDiv}>
          {showOptions && (
            <div className={styles.options}>
              <div className={styles.optionBtn} onClick={handleEditClick}>
                Edit
              </div>
              <div className={styles.optionBtn} onClick={handleCopyLink}>
                Share
              </div>
              <div
                className={styles.optionBtnDelete}
                onClick={handleDeleteClick}
              >
                Delete
              </div>
              <div className={styles.optionBtn}>
                <Link to={`/task/${taskId}`}> view</Link>
              </div>
            </div>
          )}
        </div>
