...
function DashboardContent() {
  ...
  const toggleCloseModal = (taskId) => {
    // Update to pass taskId to delete modal
    ...
    <>
      <div className={styles.dashboardScreen}>
        <div className={styles.dashboardHeader}>
          <h2 className={styles.dashboardHeaderName}>Welcome {userName}</h2>
          <p className={styles.dashboardDate}>{currentDate}</p>
            <h2 className={styles.dashboardTitle}>Board</h2>
          <div>
            <button className={styles.modeBtn} onClick={handleTodoClick}>
              To Do
            </button>
            <button className={styles.modeBtn} onClick={handleBacklogsClick}>
              Backlog
            </button>
            <button className={styles.modeBtn} onClick={handleprogessClick}>
              In Progress
            </button>
            <button className={styles.modeBtn} onClick={handleDoneClick}>
              Done
            </button>

            <div className={styles.dashboardOptionDiv}>
              <select className={styles.dashboardOptions}>
                <option className={styles.optionList} value="today">
                  Today
                </option>
                <option className={styles.optionList} value="week">
                  This Week
                </option>
                <option className={styles.optionList} value="month">
                  This Month
                </option>
              </select>
            </div>
                ...
                <div className={styles.progressBlockHeader}>
                  ...
                  <div className={styles.BtnDiv}>
                    <button
                      ...
                      onClick={handleCollapseAllProgress}
                    >
                      <img src={collapseAllIcon} alt="collapse logo" />
                    </button>
                  </div>
                </div>
              ...
              <div className={styles.dashboardBlock}>
                <div className={styles.backlogBlockHeader}>
                  ...
                  <div className={styles.BtnDiv}>
                    <button
                      className={styles.addButton}
                      onClick={handleCollapseAllBacklog}
                    >
                      <img src={collapseAllIcon} alt="collapse logo" />
                    </button>
                  </div>
      ...
      <DeleteCardModal
        ...
        onDeleteConfirm={handleCardDeleted}
      />
      <ToastContainer />
    </>
  );
